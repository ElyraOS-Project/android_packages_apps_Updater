...
public final class Constants {
    ...
    public static final String PROP_ALLOW_MAJOR_UPGRADES = "elyra.updater.allow_major_upgrades";
    public static final String PROP_LEGACY_ALLOW_MAJOR_UPGRADES =
            "lineage.updater.allow_major_upgrades";
    public static final String PROP_BUILD_DATE = "ro.build.date.utc";
    public static final String PROP_BUILD_VERSION = "ro.elyra.build.version";
    public static final String PROP_LEGACY_BUILD_VERSION = "ro.lineage.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.elyra.device";
    public static final String PROP_LEGACY_DEVICE = "ro.lineage.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.elyra.releasetype";
    public static final String PROP_LEGACY_RELEASE_TYPE = "ro.lineage.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "elyra.updater.allow_downgrading";
    public static final String PROP_LEGACY_UPDATER_ALLOW_DOWNGRADING =
            "lineage.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "elyra.updater.uri";
    public static final String PROP_LEGACY_UPDATER_URI = "lineage.updater.uri";
